...
// octo
class ErrorHandler extends _Action.default {
  /**
  ...
  static isHandler(Instance = null) {
    ...
    return Instance !== undefined && Instance !== null && instance instanceof ErrorHandler && (0, _internals.hasProp)(Instance, 'error', 'number', true, true) && (0, _internals.hasProp)(Instance, 'method', 'string', true) && (0, _internals.hasProp)(Instance, 'path', 'string', false) && (0, _internals.hasFunction)(instance, 'handle', true);
  }
  /**

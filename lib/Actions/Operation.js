...
class OctoOperation extends _Action.default {
  ...
  static isOperation(Instance = null) {
    ...
    return Instance !== undefined && Instance !== null && instance instanceof OctoOperation && (0, _internals.hasProp)(Instance, 'method', 'string', true) && (0, _internals.hasProp)(Instance, 'path', 'string', true) && (0, _internals.hasFunction)(instance, 'execute', true);
  }
  /**

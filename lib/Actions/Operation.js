...
// octo
class Operation extends _Action.default {
  /**
  ...
  static isOperation(Instance = null) {
    ...
    return Instance !== undefined && Instance !== null && instance instanceof Operation && (0, _internals.hasProp)(Instance, 'method', 'string', true) && (0, _internals.hasProp)(Instance, 'path', 'string', false) && (0, _internals.hasFunction)(instance, 'execute', true);
  }
  /**

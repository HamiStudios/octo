...
// octo
class Route extends _Action.default {
  /**
  ...
  static isRoute(Instance = null) {
    ...
    return Instance !== undefined && Instance !== null && instance instanceof Route && (0, _internals.hasProp)(Instance, 'method', 'string', true, true) && (0, _internals.hasProp)(Instance, 'path', 'string', false, true) && (0, _internals.hasFunction)(instance, 'render', true) && (0, _internals.hasFunction)(instance, 'before') && (0, _internals.hasFunction)(instance, 'after');
  }
  /**

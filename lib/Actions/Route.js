...
class OctoRoute extends _Action.default {
  ...
  static isRoute(Instance = null) {
    ...
    return Instance !== undefined && Instance !== null && instance instanceof OctoRoute && (0, _internals.hasProp)(Instance, 'method', 'string', true, true) && (0, _internals.hasProp)(Instance, 'path', 'string', true, true) && (0, _internals.hasFunction)(instance, 'render', true) && (0, _internals.hasFunction)(instance, 'before') && (0, _internals.hasFunction)(instance, 'after');
  }
  /**
    ...
    const bind = method => {
      ...
      if (Array.isArray(Instance.path)) {
        Instance.path.forEach(path => {
          expressApp[methodFunc](path, getExpressCallback(path));
        });
      } else {
        expressApp[methodFunc](Instance.path, getExpressCallback(Instance.path));
      }
    };

...
class Server {
  ...
  start(callback = () => {}) {
    ...
    _ServerHelper.default.addMiddlewares(this.expressApp, this.middlewares.filter(mw => mw.afterRoutes === true)); // check whether ssl is enabled and the private key and certificate paths exist

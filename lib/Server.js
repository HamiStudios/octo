...
class OctoServer {
  ...
  constructor(options) {
     ...
     * @type DefaultOptions
     */
    this.options = (0, _o.merge)(OctoServer.defaultOptions, options); // create an express app
  ...
  getBoundProtocol() {
    if (this.serverListener !== null) {
      return String(_Protocol.default.valueOf(this.options.protocol));
    }
...
_defineProperty(OctoServer, "defaultOptions", {
  protocol: _Protocol.default.HTTP,
  port: 6262,
  host: '127.0.0.1'
});

var _default = OctoServer;
